...
public class AntSimGUI extends JFrame {
    ...
    private class ControlPanel extends JPanel {
         ...
         *  attributes
         ************/
        // button for quitting a simulation
        private JButton quitSimButton;
        ...
        private void initComponents() {
            // quit button
            quitSimButton = new JButton("Quit");
            quitSimButton.addActionListener(buttonHandler);
            quitSimButton.setToolTipText("Quit simulation");            
            // setup button
        ...
        private class ButtonHandler implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (b.getText().equals("Normal Setup")) {
                    ...
                    // set for testing the queen ant
                    fireSimulationEvent(SimulationEvent.EXIT_EVENT);
                }
            }
        }
    }
